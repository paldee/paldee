...
### 🏆 Hackathons & Awards 
- 🥇 **1st Place (Royal Trophy)** - *BDI Hackathon* (Built an NMR peak detection model without needing labeled data)
- 🥇 **1st Place** - *Thailand Anti-Scam Ideathon by Google* (Developed "Luxurer", an AI scam detection project, and got to present as a Youth Ambassador in Kuala Lumpur!)
- 🥈 **1st Runner-up** - *Agentic AI for Healthcare Hackathon* (Created a medical-reasoning API for Thai healthcare questions using LLMs)
